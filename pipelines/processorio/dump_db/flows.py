...
rj_cvl_processorio_flow = deepcopy(dump_sql_flow)
rj_cvl_processorio_flow.state_handlers = [
    handler_inject_bd_credentials,
    handler_initialize_sentry,
]
...
rj_cvl_processorio_flow = set_default_parameters(
    rj_cvl_processorio_flow,
    default_parameters=processorio_default_parameters,
)

rj_cvl_processorio_flow.schedule = processorio_infra_daily_update_schedule
